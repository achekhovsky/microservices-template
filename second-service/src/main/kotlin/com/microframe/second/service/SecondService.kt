...
open class SecondService {
    ...
    private fun getSecondFallback(secondName: String, locale: Locale, t: Throwable): SecondServiceModel {
        var fm = SecondServiceModel()
        fm.let {
            it.secondName = secondName
            it.description = "This instance was generated by a fallback method, it is not possible to get the service instance from the database."
        }
        return fm
    }
